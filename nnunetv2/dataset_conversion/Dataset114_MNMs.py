...
def make_out_dirs(dataset_id: int, task_name="MNMs"):
...
def save_cardiac_phases(patients: list[Path], patient_info: dict[str, dict[str, int]], out_dir: Path, labels_dir: Path = None):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "--csv_file_name",
        type=str,
        default="211230_MnMs_Dataset_information_diagnosis_opendataset.csv",
